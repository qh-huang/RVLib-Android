...
public class Transform {
    ...
    public static Transform fromXYPlanePose2D(double x, double y, double theta) {
        Vector3 trans = new Vector3(x,y,0);
        Quaternion rot = Quaternion.fromAxisAngle(Vector3.zAxis(), theta);
